    ...
    <?php if(filled($activeManager) && isset($managers[$activeManager])): ?>
        ...
        >
            ...
            <?php if($managers[$activeManager] instanceof \Filament\Resources\RelationManagers\RelationGroup): ?>
                <?php $__currentLoopData = $managers[$activeManager]->ownerRecord($ownerRecord)->pageClass($pageClass)->getManagers(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupedManager): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
...
<?php /**PATH C:\xampp2\htdocs\gestao\vendor\filament\filament\src\/../resources/views/components/resources/relation-managers.blade.php ENDPATH**/ ?>