        ...
        <?php $__currentLoopData = $getChildComponentContainer()->getComponents(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="fi-fo-wizard-header-step relative flex">
                <button
                    ...
                    x-bind:disabled="! isStepAccessible(step, <?php echo e($loop->index); ?>)"
                    role="step"
...
<?php /**PATH C:\xampp2\htdocs\gestao\vendor\filament\forms\src\/../resources/views/components/wizard.blade.php ENDPATH**/ ?>