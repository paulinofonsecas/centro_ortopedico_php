...
<?php $component->withAttributes(['inline-prefix' => true,'prefix-icon' => 'heroicon-m-magnifying-glass','prefix-icon-alias' => 'panels::global-search.field','wire:target' => 'search']); ?>
        <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.input.index','data' => ['autocomplete' => 'off','inlinePrefix' => true,'placeholder' => __('filament-panels::global-search.field.placeholder'),'type' => 'search','wire:model.live.debounce.500ms' => 'search','xBind:id' => '$id(\'input\')','wire:key' => 'global-search.field.input','xData' => '{}','attributes' => 
...
<?php /**PATH C:\xampp2\htdocs\gestao\vendor\filament\filament\src\/../resources/views/components/global-search/field.blade.php ENDPATH**/ ?>